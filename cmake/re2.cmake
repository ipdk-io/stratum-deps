...
GetDownloadClause(_download_clause
  ${RE2_GIT_URL}
  ${RE2_GIT_TAG}
)
...
ExternalProject_Add(re2
  ${_download_clause}
  SOURCE_DIR ${DEPS_SOURCE_DIR}/re2
  CMAKE_ARGS
    ${deps_BUILD_TYPE}
    ${deps_TOOLCHAIN_FILE}
  ...
  INSTALL_COMMAND ${SUDO_CMD} ${CMAKE_MAKE_PROGRAM} install
    ${LDCONFIG_CMD}
)
...
set_target_properties(re2::re2 PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "${CMAKE_INSTALL_PREFIX}/lib/libre2.so"
)
